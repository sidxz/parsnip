...
/**
 * 2D: Chemical Impact (CI) vs Feasibility
 *
 * Props:
 * - scores: { chemistryScore?: number, likelihoodScore?: number }
 * - evaluatedTarget: string
 */
export default function TargetGraph2DChemicalVsFeasibility({
  scores,
  evaluatedTarget = "",
}) {
  ...
  const x = valid.map((t) => t.chemicalInhibitionScore); // CI
